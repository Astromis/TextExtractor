...
test: main.o djvu_extractor.o pdf_extractor.o tesseract_wp.o text_extractor.o docx_reader.o czip.o
	$(CC) main.o djvu_extractor.o pdf_extractor.o tesseract_wp.o text_extractor.o docx_reader.o czip.o -std=c++11 -o test -llept -ltiff -ldjvulibre -ltesseract -lpoppler-cpp -lzip -lpthread -lstdc++fs
    
main.o: main.cpp
	$(CC) $(CFLAGS) -c -std=c++11 main.cpp -I /usr/include/poppler/cpp/ -lpthread -lstdc++fs

text_extractor.o: text_extractor.cpp
	$(CC) $(CFLAGS) -c text_extractor.cpp -I /usr/include/poppler/cpp/
...
pdf_extractor.o: pdf_extractor.cpp
	$(CC) $(CFLAGS) pdf_extractor.cpp -ltesseract -llept -lpoppler-cpp -I /usr/include/poppler/cpp/
	
tesseract_wp.o: tesseract_wp.cpp
	$(CC) $(CFLAGS) -ltesseract tesseract_wp.cpp -lpthread
